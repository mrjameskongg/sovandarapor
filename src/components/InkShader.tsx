...
/**
 * Drifting ink shader — a slow, low-contrast fbm flow tinted with gold.
 * Sits behind hero content as a subtle living texture.
 * - Skips animation on prefers-reduced-motion
 * - Pauses when tab hidden / canvas off-screen
 * - Pure WebGL, no deps
 */
