  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        'spectral': ['Source Serif Pro', 'Georgia', 'serif'],
      ...
      colors: {
        ...
        ink: "hsl(var(--ink))",
        paper: "hsl(var(--paper))",
        slate: { DEFAULT: "hsl(var(--slate))", light: "hsl(var(--slate-light))" },
        content: { DEFAULT: "hsl(var(--content))", muted: "hsl(var(--content-muted))" },
      },
      backgroundImage: {
